...
//tests
describe('Test suite with PO - Room', () =>{

    beforeEach ('Visit website and log in with valid inputs', () => {
    ...
    it('Create a room by entering valid inputs in all fields', () => {
        indexPage.navigateToRooms('Rooms')
    ...
    it('Create a room without entering the price', () => {
        indexPage.navigateToRooms('Rooms')
        roomsPage.navigateToCreateRoom('New Room')
    ...
    it('Use Back button on page for creating new room', () => {
        indexPage.navigateToRooms('Rooms')
        roomsPage.navigateToCreateRoom('New Room')
    ...
    it('Return to homepage when on Rooms page', () => {
        indexPage.navigateToRooms('Rooms')
        roomsPage.returnToIndexPage('Tester Hotel Overview')
        indexPage.performLogout('Login')
    })

    //more tests for rooms pages
    it('Delete room on page Rooms', () => {
        indexPage.navigateToRooms('Rooms')
        roomsPage.navigateToCreateRoom('New Room')
        createRoomPage.createRoom(randomCategory, randomRoomNumber, randomFloorNumber, randomAvailability, randomPrice, randomFeature)
        createRoomPage.saveRoom('Rooms')
    ...
    it('Edit floor number of a room', () => {
        indexPage.navigateToRooms('Rooms')
        roomsPage.navigateToCreateRoom('New Room')
        createRoomPage.createRoom(randomCategory, randomRoomNumber, randomFloorNumber, randomAvailability, randomPrice, randomFeature)
        createRoomPage.saveRoom('Rooms')
    ...
    it('Edit availability of a room', () => {
        indexPage.navigateToRooms('Rooms')
        roomsPage.navigateToCreateRoom('New Room')
        createRoomPage.createRoom(randomCategory, randomRoomNumber, randomFloorNumber, randomAvailability, randomPrice, randomFeature)
        createRoomPage.saveRoom('Rooms')
